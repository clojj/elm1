...
((w,d,x,n,h,c,r)=>{((s)=>{s&&(r=s.getAttribute('data-resources-url'))})(d.querySelector("script[data-namespace='mycounter']"));
/**
 * SSR Attribute Names
 */
...
})(window,document,{},"mycounter","hydrated",[["my-counter","my-counter",1,[["max",1,0,1,8],["min",1,0,1,8],["start",1,0,1,8],["step",1,0,1,8],["value",16]]]]);